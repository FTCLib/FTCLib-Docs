...
Currently, there is a Road Runner quickstart that uses FTCLib [here](https://www.github.com/FTCLib/RoadRunner-FTCLib-Quickstart), It makes use of the [command-based](command-base/command-system/) paradigm.
